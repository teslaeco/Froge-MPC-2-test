...
files = ['install.sh', 'server.py', 'ai_stream.py', 'openai_provider.py', 'runtime_check.py', 'apply_update.py', 'code_policy.py', 'pull_model.py', 'runtime/run.py', 'runtime/scene_contract.py', 'runtime/build_scene.py', 'runtime/detailed_geometry.py', 'runtime/anatomy.py', 'README.md'] + assets
...
with zipfile.ZipFile(root/'public/downloads/froge-oracle-update.zip','w',zipfile.ZIP_DEFLATED) as archive:
    for name in ['server.py', 'ai_stream.py', 'openai_provider.py', 'runtime_check.py', 'code_policy.py', 'runtime/run.py', 'runtime/scene_contract.py', 'runtime/build_scene.py', 'runtime/detailed_geometry.py', 'runtime/anatomy.py', 'apply_update.py'] + assets:
        info=zipfile.ZipInfo(name,date_time=(2026,9,6,0,0,0));info.compress_type=zipfile.ZIP_DEFLATED
        archive.writestr(info,(root/'oracle_connector'/name).read_bytes())
