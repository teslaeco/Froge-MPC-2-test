...
template=template.replace("health.get('portraitRevision') != 1:","health.get('portraitRevision') != 2 or health.get('coutureRevision') != 2 or health.get('characterStandard') != 20 or health.get('referenceQualityRevision') != 1:")
