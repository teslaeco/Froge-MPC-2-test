...
- Native anatomy regression added to CI and the installer. CI verified it in
  real Blender 4.3.0, including protected lash joins. Local Blender is absent.
...
1. COMPLETED: both Python 3.9 and 3.12 CI jobs passed, 98 tests each;
   real pinned Codex smoke and delayed post-finish read passed. Blender 4.3.0
   built/rendered/exported/reimported fixtures and passed anatomy/edit gates.
...
Verified source: 2c4ca6e78b4f77a2011e6c7a3211caf923ca18f3.
CI run: https://github.com/teslaeco/Froge-MPC-2-test/actions/runs/34685206191
Both jobs succeeded. Native logs confirm CODEX_FINISHED_READ_OK,
CODEX_MCP_BLENDER_BUILD_OK, FROGE_EDIT_RUNTIME_OK and FROGE_ANATOMY_EDIT_OK.
Valid anatomy fixture retains one head, two eyes, two hands and ten nails.
Deleted nail and missing UV are rejected; failed revision has no GLB.
CLI used fixture Responses, not a paid model or likeness assessment.
Package contents are byte-identical to tested program source: 60 code/data files,
5 pinned unchanged assets. ZIP SHA256:
18a56f04997de43ac07e436389d08af6a45f04b6955bafa0a8485fb6f830be81.
Oracle Console navigation/refresh timed out; no Oracle terminal session obtained.
