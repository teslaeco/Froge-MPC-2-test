...
views=[('face',face,scale,0),('front',Vector((0,.02,1.15)),1.32,0),('fabric',Vector((0,-.05,1.06)),.61,0),('face-angle',face,scale,.55),('left',Vector((0,.02,1.15)),1.32,math.pi/2),('back',Vector((0,.02,1.15)),1.32,math.pi)]
