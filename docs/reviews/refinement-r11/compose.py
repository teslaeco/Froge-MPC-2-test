...
import json,hashlib
p=Path('/workspace/scratch/584c9d97a5a1/refinement-r11');f=ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf',24)
...
sheet('FORGE-r11-trzy-widoki.png',[(p/'FBX-front.png','R11 — PRZÓD'),(p/'FBX-left.png','R11 — LEWY BOK'),(p/'FBX-back.png','R11 — TYŁ (INTERPRETACJA)')])
sheet('FORGE-r11-twarz.png',[(p/'FBX-face.png','R11 — TWARZ'),(p/'FBX-face-clay.png','R11 — GEOMETRIA BEZ TEKSTUR')])
files=['FORGE-r11-trzy-widoki.png','FORGE-r11-twarz.png','FORGE-model-r11-2000k.fbx','FORGE-model-r11-2000k.blend','FORGE-model-r11-2000k.glb']
