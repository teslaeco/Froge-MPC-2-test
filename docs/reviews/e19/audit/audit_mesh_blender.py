...
def main():
    ...
    report = {
        ...
        'dimension_matches_expected_height': bool(args.expected_height_mm is not None and abs((high-low)[2]-args.expected_height_mm) <= 0.01),
        'scale_confirmed_by_customer': False,
