...
face,scale,_=face_framing(meshes)
...
views=[('face',face,scale,0),('front',Vector((0,.02,1.29)),1.18,0),('left',Vector((0,.02,1.29)),1.18,math.pi/2),('back',Vector((0,.02,1.29)),1.18,math.pi)]
