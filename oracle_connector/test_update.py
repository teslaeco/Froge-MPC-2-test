...
class UpdateTests(unittest.TestCase):
    def setUp(self):
        ...
        for name in ('agent_limits.py','paid_trial.py','generation_budget.py','quality_report.py','v23_fixture.py','scene_repair.py','blender_mcp.py','codex_runner.py','install_codex.py','codex_smoke.py'):
