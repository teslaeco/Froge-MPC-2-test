...
class UpdateTests(unittest.TestCase):
    def setUp(self):
        ...
        for name in ('portrait.py','portrait_eyes.py','portrait_shape.py','portrait_orbits.py','portrait_hands.py','portrait_hair.py','portrait_hair_surface.py','portrait_locks.py','rooted_hair.py','fashion.py','couture.py','couture_geometry.py','couture_qa.py','review_views.py','scene_exports.py','imported_asset.py'):
