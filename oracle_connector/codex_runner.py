...
def run(folder,prompt,instructions,key,cancelled,progress,binary=None):
    ...
    task=('Complete the user 3D task using the attached original images and the Blender MCP tools. '
          ...
          'Before the first build compare the actual reference: classify living versus skeletal anatomy, '
          'record visible silhouette, face landmarks, mouth expression, hairstyle and garment construction. '
          'Use this job\'s images and latest brief to decide hair colour, age cues, eye presence and outfit; '
          'do not inherit a previous character\'s grey hair, dress, anatomy or proportions. '
          'For a half-human/half-skull use portrait.eye_states from the contract; anatomical left is viewer-right '
          'in a frontal image. A deliberately empty socket must not retain a globe or eyelashes. '
          'A skeletal side may instead explicitly contain an eye: then declare that eye present, keep its '
          'globe recessed behind the orbital rim and match the observed dark iris and modest highlight. '
          'Do not treat every skull as an empty socket or enlarge the globe into a black bead at the rim. '
          'The base only omits declared parts; it is NOT a reconstructed skull. Sculpt its recessed orbital '
          'cavity, nasal opening, cheekbone and jaw, and connect the central nose/lip/chin seam continuously. '
          'Build teeth along upper/lower dental arches with distinct incisor/canine/molar shapes and scale, '
          'not a uniform rectangular grid. Match wavy hair with separate flowing volumes rooted at the scalp; '
          'do not flatten curls into straight sheets. Close visible root gaps with scalp-fitted tapered '
          'strands following the parting, not a smooth exposed helmet. Preserve the living half and the observed smile. '
          'Use an original-reference camera with matching framing before evaluating likeness. Compare silhouette, '
          'eye/socket, nose, mouth/seam, teeth, hair and the actual garment separately; use clay views to reveal texture-hidden '
          'geometry faults. Correct the largest mismatch first; extra subdivisions or 4K textures cannot fix shape. '
          'Reject acceptance if any defining feature is wrong, including a globe in an explicitly empty socket, '
          'a missing eye when the reference requires one, a broken seam, '
          'regular oversized teeth, wrong hairstyle or major head/neck proportions. Identify unseen surfaces as inferred. '
