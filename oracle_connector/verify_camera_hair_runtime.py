"""Native Blender regression: baked eye origins and rooted UV hair volumes."""
import sys,json
...
print('CAMERA_HAIR_NATIVE_PASS',json.dumps({'face_center':list(centre),'face_scale':scale,'hair_vertices':len(lock.data.vertices),'closed':True,'empty_old_frame_rejected':True}))
