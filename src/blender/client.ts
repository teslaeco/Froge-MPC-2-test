...
export type GenerationJob = { id: string; prompt: string; state: string; detail: string; created: string; updated: string; hasModel: boolean; modelStorage?: 'available' | 'missing' | 'unavailable'; referencePhotos?: JobPhoto[] }
export type GenerationHistory = { jobs: GenerationJob[]; nextCursor?: string }
