...
export const RECOMMENDED_CONNECTOR_VERSION = 21
...
export const supportsPhotoGeneration = (connection?: { connectorVersion?: number; photoInput?: boolean; provider?: string; image3dRevision?: number; image3dReady?: boolean } | null) => (connection?.connectorVersion ?? 0) >= 21 && connection?.image3dRevision === 1 && connection.image3dReady === true
