...
export const RECOMMENDED_CONNECTOR_VERSION = 22
...
export const supportsPhotoGeneration = (connection?: { connectorVersion?: number; photoInput?: boolean; provider?: string; image3dRevision?: number; image3dReady?: boolean } | null) => (connection?.connectorVersion ?? 0) >= 14 && connection?.connectorVersion !== 21 && connection?.provider === 'openai' && connection.photoInput === true
